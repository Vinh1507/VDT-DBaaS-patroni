...
urlpatterns = [
    ...
    path('clusters/create', views.create_cluster, name='create-cluster'),  # POST
    path('clusters/switchover/', views.switchover, name='switchover'),  # POST
    path('clusters/failover/', views.failover, name='failover'),  # POST
    path('clusters/add-node/', views.add_node, name='add-node'),  # POST
